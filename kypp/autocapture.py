...
is a no-op (wire's .kypp-observed marker), and in-flight sessions are skipped until they finish, so
...
if __name__ == "__main__" and len(sys.argv) > 1:
    ...
    assert os.path.exists(os.path.join(done, "log.jsonl.kypp-observed")), "completed → marked"
